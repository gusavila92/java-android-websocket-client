...
public class VersionInfo {
     ...
     *                  for example "tech.gusavila92.apache.http".
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // tech.gusavila92.apache.http      becomes
     ...
     * @param pkg
     *            the package for which to load version information, for example "tech.gusavila92.apache.http". The package name
